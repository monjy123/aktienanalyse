...
# -*- coding: utf-8 -*-
"""
Erweitert die Tabelle analytics.live_metrics um Count-Spalten
...
def main():
    ...
    try:
        ...
        print("Erweitere Tabelle analytics.live_metrics um Count-Spalten...")
        ...
        for col_name, col_def in NEW_COLUMNS:
            if col_name in existing_columns:
                ...
                alter_sql = f"ALTER TABLE analytics.live_metrics ADD COLUMN {col_name} {col_def}"
